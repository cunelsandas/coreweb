...
@section('content')
                ...
                <div class="card border-0 h-100">
                    ...
                    <div class="text-center mb-2">
                        <button type="button" class="btn btn-success" @click="viewData('')">
                            <i class="fa fa-plus"></i> แจ้งชำระภาษี
                        </button>
                    </div>

                    <div class="text-center mb-2">
                        <img src="{{url('/')}}/upload/qrpaytax/qr.png">
                    </div>
    ...
    @include('frontend_layouts2.paytax._form')
    @include('frontend_layouts2.paytax._layout')
    @include('frontend_layouts2.paytax._script')
@endsection
