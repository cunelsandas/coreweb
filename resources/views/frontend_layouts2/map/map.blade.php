<style>
    <!--
    -->
    /*@php //echo file_get_contents(FOLDERIMG . 'map/mapCustom.css') @endphp*/
    .animation {
        width: 100%;
    }
   ...
   /* .head-map {              head title text
    ...
    .map {
        background: url('{{url('/')}}/upload/map/map.png') top center no-repeat;
        z-index: 2;
        top: 10px;
        width: 100%;
        height: 100%;
...
<div class="container-blog" style="overflow:hidden; z-index:1;margin-top: -1%">
    <div class="animation" id="animation" style="width: 100%" data-img="">
   ...
   <!--     <div class="head-star animated infinite"></div> -->
    ...
    animation-delay: 0.4s;">
                <a class="popup" data-img="{{url('/')}}/upload/map/Maengaddam.jpg"
...
สังกัดคณะสงฆ์มหานิกาย สร้างเมื่อ พ.ศ. 2500 ได้รับการพระราชทานวิสุงคามสีมา เมื่อวันที่ 14 สิงหาคม พ.ศ. 2551">
    ...
    animation-delay: 0.1s;">
                <a class="popup" data-img="" data-head="วัดช่อแลพระงาม"
    ...
    animation-delay: 0.5s;">
                <a class="popup" data-img="" data-head="วัดศรีภูมินทร์(สันป่าสัก)"
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 0; height: 66px;">
                ...
                <div class="close" style="padding: 0;position: absolute;top: -6px;left: 769px;opacity: 1;"
                     data-dismiss="modal">
                    <img src="{{url('/')}}/upload/map/close.png" alt=""
