<script type="text/x-template" id="permission-manage">
    <div class="modal fade" id="permission-modal">
        <div class="modal-dialog modal-lg " role="document">
            <form @submit.prevent="save(data.domain,$event)">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div v-for="val,key in data.modules" class="custom-control custom-checkbox">
                            <input name="permission[]" type="checkbox" class="custom-control-input"
                                   :id="'check-'+key" :value="val.id" :checked="val.check">
