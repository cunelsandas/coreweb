...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-9 col-12">
                <div class="card border-0 h-100">
                    <h3 class="ml-4 mt-4"><i class="fa fa-youtube-play" style="font-size:48px;color:red"></i> จัดการ{{$title}}</h3>
                    <div class="card-body">
    ...
    @include('backend.youtube._form')
    @include('backend.youtube._layout')
    @include('backend.youtube._script')
@endsection
