...
@section('content')
    ...
    <script>
        @foreach($waterworks as $waterwork)
        {{$waterwork->f_lat}}
        @endforeach
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <div class="card border-0 h-100">
                    <h3 class="ml-4 mt-4"><i class="fas fa fa-tint"></i> {{$title ?? ''}}</h3>
...
{{--                        </button>--}}
    ...
    @include('backend.waterwork._form')
    @include('backend.waterwork._layout')
    @include('frontend.waterwork._script')
@endsection
