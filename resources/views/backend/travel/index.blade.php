...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-9 col-12">
                <div class="card border-0 h-100">
                    <h3 class="ml-4 mt-4"><i class="fa fa-map-pin"></i> จัดการ{{$title}}</h3>
                    <div class="card-body">
    ...
    @include('backend.travel._form')
    @include('backend.travel._layout')
    @include('backend.travel._script')
@endsection
