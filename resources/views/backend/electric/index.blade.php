...
@section('content')
    ...
    <script>
        ...
        function initMap(){
            myLatLng = {lat: {{$electric->f_lat}}, lng: {{$electric->f_lng}}};
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <div class="card border-0 h-100">
                    <h3 class="ml-4 mt-4"><i class="fas fa fa-bolt"></i> {{$title ?? ''}}</h3>
...
{{--                        </button>--}}
    ...
    @include('backend.electric._form')
    @include('backend.electric._layout')
