...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-9 col-12">
                <div class="card border-0 h-100">
                    <h3 class="ml-4 mt-4"><i class="fa fa-folder-open"></i> ไฟล์เอกสาร{{$title}}</h3>
                    <div class="card-body">
    ...
    @include('backend.document._form')
    @include('backend.document._layout')
    @include('backend.document._script')
@endsection
