...
{{--                                    <button @click="edit(val.id)" type="button" class="btn btn-warning" title="แก้ไข"><i--}}
{{--                                            class="fa fa-edit"></i></button>--}}
{{--                                    <button @click="remove(val.id)" type="button" class="btn btn-danger"--}}
{{--                                            title="ลฟหดหฟดบ"><i class="fa fa-trash"></i></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
@elseif($layout == 3)
    ...
    <script type="text/x-template" id="table-manage">
        <div class="row my-2">
            <div v-for="val in data" class="col-lg-3 col-sm-6 mt-2">
...
@elseif($layout == 4)
    ...
    <script type="text/x-template" id="table-manage">
        <div class="row my-2">
            <div class="col-12">
                <div class="card mb-3" v-for="val in data">
                    <div class="row no-gutters">
                        <div class="col-md-4 p-1 text-center">
                            <a style="color: black" :href="val.url">
                            <img v-if="val.file.img" class="card-img-top" :src="val.file.url">
...
{{--                                </a>--}}
                                <a style="color: black" :href="val.url">
                                <h5 class="card-title">
                                    <a class="card-link" href="#!" title="แก้ไข" @click="edit(val.id)">@{{ val.name }}</a>
                                </h5>
                                </a>
                                <p class="card-text text-truncate">@{{ val.detail}}</p>
                                <p class="card-text"><small class="text-muted"></small></p>
