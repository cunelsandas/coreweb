...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.module.index')->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = array();
        if (!$id && !$type) {
            $module_admin = DB::table($table_name)->where('manage_sub', '=', 1)->get()->toArray();
            ...
            $modules = DB::table($table_name)->where('id', '=', $id)->get()->first();
            $result = array(
                'data' => $modules,
            );
        } else {// Sub Module Manage
            $modules = DB::table($table_name)->where('id', '=', $type)->get()->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($id && !$route) { // Module Manage
            ...
            $modules = DB::table($table_name)->where('id', '=', $route)->get()->first();
