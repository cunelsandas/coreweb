...
class WaterworkController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $waterworks = DB::connection('db2')
            ->table('waterworks')
            ->select('*')
            ->get();
        return view('backend.waterwork.index')->with(['title' => $title, 'url' => $url, 'layout' => 1, 'limit' => 5 ,'waterworks'=>$waterworks]);
        //
    }
